...
# connectedCallback cannot find slotted children

In a dev build, an Element in connectedCallback finds its slotted children just fine,
using querySelector. However, in a prod build, slotted children cannot be found.

This occurs only for components with shadowDom: false, with children passed from
a parent's slot, to a child's.
...
2. Run `npm serve`, observe the javasdript console agian. This npm script runs
